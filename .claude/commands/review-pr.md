...
3. For each changed file, analyze the diff and check for:
   ...
   - **Style**: Naming conventions, error handling, formatting, idiomatic Go/C# patterns
   - **Tests**: Whether new/changed code has adequate test coverage
   - **Error handling**: Errors returned up the stack, logged appropriately
   - **Input validation**: Validated before processing
